...
void MorphAndEnqueuePromiseReaction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<PromiseReaction> p_promiseReaction, TNode<Object> p_argument, PromiseReaction::Type p_reactionType) {
  ...
  if (block5.is_used()) {
    ...
    tmp18 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kEnqueueMicrotask), tmp9, tmp15);
  ...
  if (block6.is_used()) {
    ...
    tmp30 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kEnqueueMicrotask), tmp9, tmp26);
...
USE(parameter1);
  ...
  if (block2.is_used()) {
    ...
    tmp20 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kRejectPromise), tmp0, tmp4, parameter2, tmp19);
...
USE(parameter1);
  ...
  if (block2.is_used()) {
    ...
    tmp15 = True_0(state_);
    CodeStubAssembler(state_).StoreReference<Oddball>(CodeStubAssembler::Reference{tmp13, tmp14}, tmp15);
    tmp16 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kResolvePromise), tmp0, tmp4, parameter2);
...
void PerformPromiseThenImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSPromise> p_promise, TNode<HeapObject> p_onFulfilled, TNode<HeapObject> p_onRejected, TNode<HeapObject> p_resultPromiseOrCapability) {
  ...
  if (block7.is_used()) {
    ...
    tmp21 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kEnqueueMicrotask), phi_bb7_7, phi_bb7_6);
    ca_.Goto(&block4);
  }
...
USE(parameter1);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    tmp9 = True_0(state_);
    tmp10 = ca_.CallStub<PromiseCapability>(Builtins::CallableFor(ca_.isolate(), Builtins::kNewPromiseCapability), parameter0, tmp0, tmp9);
...
TNode<Object> CallResolve_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_constructor, TNode<Object> p_resolve, TNode<Object> p_value) {
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp2 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kPromiseResolve), p_context, p_constructor, p_value);
    ca_.Goto(&block1, tmp2);
  }
