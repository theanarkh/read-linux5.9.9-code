...
TNode<Object> RegExpPrototypeMatchAllImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_receiver, TNode<Object> p_string) {
  ...
  if (block5.is_used()) {
    ...
    tmp16 = ca_.CallStub<Smi>(Builtins::CallableFor(ca_.isolate(), Builtins::kStringIndexOf), p_context, tmp9, tmp14, tmp15);
    ...
    tmp21 = ca_.CallStub<Smi>(Builtins::CallableFor(ca_.isolate(), Builtins::kStringIndexOf), p_context, tmp9, tmp19, tmp20);
