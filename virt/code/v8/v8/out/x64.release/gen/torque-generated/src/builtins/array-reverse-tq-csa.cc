...
TNode<Object> GenericArrayReverse_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver) {
  ...
  if (block2.is_used()) {
    ...
    tmp8 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), p_context, tmp0, phi_bb2_4);
    tmp9 = True_0(state_);
  ...
  if (block6.is_used()) {
    ...
    tmp12 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), p_context, tmp0, phi_bb6_5);
    tmp13 = True_0(state_);
  ...
  if (block9.is_used()) {
    ...
    tmp21 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, phi_bb9_4, phi_bb8_7);
    tmp22 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, phi_bb9_5, phi_bb6_6);
  ...
  if (block15.is_used()) {
    ...
    tmp28 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, phi_bb15_4, phi_bb8_7);
    tmp29 = FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(state_, LanguageMode::kStrict);
    tmp30 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), p_context, tmp0, phi_bb15_5, tmp29);
  ...
  if (block21.is_used()) {
    ...
    tmp37 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), p_context, tmp0, phi_bb21_4, tmp36);
    tmp38 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, phi_bb21_5, phi_bb6_6);
