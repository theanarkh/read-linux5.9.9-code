...
TF_BUILTIN(ToNumeric, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp2 = ca_.CallStub<Numeric>(Builtins::CallableFor(ca_.isolate(), Builtins::kNonNumberToNumeric), parameter0, ca_.UncheckedCast<HeapObject>(parameter1));
...
TF_BUILTIN(ToName, CodeStubAssembler) {
  ...
  if (block19.is_used()) {
    ...
    tmp10 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kNonPrimitiveToPrimitive_String), parameter0, ca_.UncheckedCast<JSReceiver>(phi_bb19_3));
...
TF_BUILTIN(NonPrimitiveToPrimitive_Default, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp2 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kOrdinaryToPrimitive_Number), parameter0, parameter1);
    CodeStubAssembler(state_).Return(tmp2);
  }
...
TF_BUILTIN(NonPrimitiveToPrimitive_String, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp2 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kOrdinaryToPrimitive_String), parameter0, parameter1);
    CodeStubAssembler(state_).Return(tmp2);
  }
