...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ...
    tmp10 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayForEachLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp8, tmp0, tmp4, tmp6, tmp9);
...
USE(parameter1);
  ...
  if (block10.is_used()) {
    ...
    tmp17 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayForEachLoopContinuation), parameter0, tmp1, tmp7, tmp10, tmp15, tmp1, tmp14.value(), tmp2, tmp16);
