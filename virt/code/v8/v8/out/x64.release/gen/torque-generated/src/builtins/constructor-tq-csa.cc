...
TF_BUILTIN(FastNewClosureBaseline, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
   ...
   CodeStubAssembler(state_).TailCallBuiltin(Builtins::kFastNewClosure, tmp0, parameter0, parameter1);
  }
}
...
USE(parameter3);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    tmp15 = ca_.CallStub<JSReceiver>(Builtins::CallableFor(ca_.isolate(), Builtins::kToObject), parameter0, tmp5);
  ...
  if (block2.is_used()) {
    ...
    tmp17 = ca_.CallStub<JSObject>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastNewObject), parameter0, parameter3, tmp16);
...
USE(parameter3);
  ...
  if (block4.is_used()) {
    ...
    tmp10 = ca_.CallStub<JSObject>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastNewObject), parameter0, tmp8, tmp9);
