...
TNode<Number> ToIntegerImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_input) {
  ...
  if (block12.is_used()) {
    ...
    tmp5 = ca_.CallStub<Number>(Builtins::CallableFor(ca_.isolate(), Builtins::kNonNumberToNumber), p_context, ca_.UncheckedCast<HeapObject>(phi_bb12_3));
...
TNode<Number> ToInteger_Inline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_input) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp2 = ca_.CallStub<Number>(Builtins::CallableFor(ca_.isolate(), Builtins::kToInteger), p_context, p_input);
...
TNode<Object> ToPrimitiveDefault_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_v) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp2 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kNonPrimitiveToPrimitive_Default), p_context, tmp0);
    ca_.Goto(&block1, tmp2);
  }
...
TNode<String> StringAdd_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<String> p_a, TNode<String> p_b) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kStringAdd_CheckNone), p_context, p_a, p_b);
    ca_.Goto(&block2);
  }
...
void VerifiedUnreachable_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp0}, "static_assert(false) at src/builtins/base.tq:1760:3");
    CodeStubAssembler(state_).Unreachable();
  }
}
