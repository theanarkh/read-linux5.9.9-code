...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp8 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayFindLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp0, tmp4, tmp6);
...
USE(parameter1);
  ...
  if (block18.is_used()) {
    ca_.Bind(&block18);
    tmp9 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayFindLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp0, tmp4, tmp6);
...
USE(parameter1);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    tmp14 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayFindLoopContinuation), parameter0, tmp1, tmp7, tmp10, tmp1, tmp13.value(), tmp2);
