...
TF_BUILTIN(WasmAllocateRtt, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).TailCallRuntime(Runtime::kWasmAllocateRtt, tmp0, tmp1, parameter1);
  }
}
...
TF_BUILTIN(WasmAllocateArrayWithRtt, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<Map> parameter0 = UncheckedParameter<Map>(Descriptor::kRtt);
  USE(parameter0);
...
TF_BUILTIN(WasmArrayCopyWithChecks, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
   CodeStubAssembler(state_).TailCallBuiltin(Builtins::kThrowWasmTrapNullDereference, TNode<Object>());
  }
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
   CodeStubAssembler(state_).TailCallBuiltin(Builtins::kThrowWasmTrapArrayOutOfBounds, TNode<Object>());
  }
...
TF_BUILTIN(WasmAtomicNotify, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp0 = WasmBuiltinsAssembler(state_).LoadInstanceFromFrame();
    tmp1 = WasmBuiltinsAssembler(state_).LoadContextFromInstance(TNode<WasmInstanceObject>{tmp0});
    tmp2 = ca_.CallStub<Number>(Builtins::CallableFor(ca_.isolate(), Builtins::kUintPtr53ToNumber), TNode<Object>(), parameter0);
    tmp3 = ca_.CallStub<Number>(Builtins::CallableFor(ca_.isolate(), Builtins::kWasmUint32ToNumber), TNode<Object>(), parameter1);
...
TF_BUILTIN(WasmI32AtomicWait64, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    tmp1 = WasmBuiltinsAssembler(state_).LoadContextFromInstance(TNode<WasmInstanceObject>{tmp0});
    tmp2 = ca_.CallStub<Number>(Builtins::CallableFor(ca_.isolate(), Builtins::kUintPtr53ToNumber), TNode<Object>(), parameter0);
    tmp3 = ca_.CallStub<Number>(Builtins::CallableFor(ca_.isolate(), Builtins::kWasmInt32ToNumber), TNode<Object>(), parameter1);
    tmp4 = ca_.CallStub<BigInt>(Builtins::CallableFor(ca_.isolate(), Builtins::kI64ToBigInt), TNode<Object>(), parameter2);
...
TF_BUILTIN(WasmI64AtomicWait64, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    tmp1 = WasmBuiltinsAssembler(state_).LoadContextFromInstance(TNode<WasmInstanceObject>{tmp0});
    tmp2 = ca_.CallStub<Number>(Builtins::CallableFor(ca_.isolate(), Builtins::kUintPtr53ToNumber), TNode<Object>(), parameter0);
    tmp3 = ca_.CallStub<BigInt>(Builtins::CallableFor(ca_.isolate(), Builtins::kI64ToBigInt), TNode<Object>(), parameter1);
    tmp4 = ca_.CallStub<BigInt>(Builtins::CallableFor(ca_.isolate(), Builtins::kI64ToBigInt), TNode<Object>(), parameter2);
