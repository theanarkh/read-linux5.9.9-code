...
TNode<JSArray> HandleFastSlice_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<Object> p_o, TNode<Number> p_startNumber, TNode<Number> p_countNumber, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block18.is_used()) {
    ca_.Bind(&block18);
    tmp11 = ca_.CallStub<JSArray>(Builtins::CallableFor(ca_.isolate(), Builtins::kExtractFastJSArray), p_context, tmp4, tmp0, tmp2);
...
USE(parameter1);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp4 = ca_.CallStub<JSArray>(Builtins::CallableFor(ca_.isolate(), Builtins::kCloneFastJSArray), parameter0, tmp2);
  ...
  if (block47.is_used()) {
    ...
    tmp35 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), parameter0, tmp5, phi_bb47_9);
    tmp36 = True_0(state_);
  ...
  if (block50.is_used()) {
    ...
    tmp39 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastCreateDataProperty), parameter0, tmp32, phi_bb50_15, tmp38);
  ...
  if (block48.is_used()) {
    ...
    tmp45 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), parameter0, tmp32, tmp44, phi_bb48_15);
