...
USE(parameter1);
  ...
  if (block11.is_used()) {
    ...
    tmp8 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayReduceLoopContinuation), parameter0, tmp0, tmp2, tmp6, tmp0, tmp7, tmp4);
...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp8 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayReduceLoopContinuation), parameter0, tmp0, tmp2, parameter5, tmp0, tmp4, tmp6);
    CodeStubAssembler(state_).Return(tmp8);
  }
}
...
USE(parameter1);
  ...
  if (block14.is_used()) {
    ca_.Bind(&block14);
    tmp18 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayReduceLoopContinuation), parameter0, tmp1, tmp7, tmp17.value(), tmp1, tmp16.value(), tmp2);
