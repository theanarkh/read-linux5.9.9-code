...
void TorqueGeneratedClassVerifiers::WeakCellVerify(WeakCell o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(unregister_token__value.IsJSReceiver() || unregister_token__value.IsSmi() || unregister_token__value.IsHeapNumber() || unregister_token__value.IsBigInt() || unregister_token__value.IsString() || unregister_token__value.IsSymbol() || unregister_token__value.IsTrue() || unregister_token__value.IsFalse() || unregister_token__value.IsNull() || unregister_token__value.IsUndefined());
  }
  {
...
void TorqueGeneratedClassVerifiers::WasmModuleObjectVerify(WasmModuleObject o, Isolate* isolate) {
  ...
  {
    Object native_module__value = TaggedField<Object>::load(o, 24);
...
void TorqueGeneratedClassVerifiers::WasmExceptionObjectVerify(WasmExceptionObject o, Isolate* isolate) {
  ...
  {
    Object exception_tag__value = TaggedField<Object>::load(o, 32);
