  ...
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_JS_RECEIVER_TYPE, 186) \
      ...
      V(FIRST_JS_OBJECT_TYPE, 189) \
        ...
        V(JS_COLLATOR_TYPE, 1089) \
        V(JS_CONTEXT_EXTENSION_OBJECT_TYPE, 1090) \
        V(JS_DATE_TYPE, 1091) \
        V(JS_DATE_TIME_FORMAT_TYPE, 1092) \
        V(JS_DISPLAY_NAMES_TYPE, 1093) \
        V(JS_ERROR_TYPE, 1094) \
        V(JS_FINALIZATION_REGISTRY_TYPE, 1095) \
        V(JS_LIST_FORMAT_TYPE, 1096) \
        V(JS_LOCALE_TYPE, 1097) \
        V(JS_MESSAGE_OBJECT_TYPE, 1098) \
        V(JS_NUMBER_FORMAT_TYPE, 1099) \
        V(JS_PLURAL_RULES_TYPE, 1100) \
        V(JS_PROMISE_TYPE, 1101) \
        V(JS_REG_EXP_TYPE, 1102) \
        V(JS_REG_EXP_STRING_ITERATOR_TYPE, 1103) \
        V(JS_RELATIVE_TIME_FORMAT_TYPE, 1104) \
        V(JS_SEGMENT_ITERATOR_TYPE, 1105) \
        V(JS_SEGMENTER_TYPE, 1106) \
        V(JS_SEGMENTS_TYPE, 1107) \
        V(JS_STRING_ITERATOR_TYPE, 1108) \
        V(JS_V8_BREAK_ITERATOR_TYPE, 1109) \
        V(JS_WEAK_REF_TYPE, 1110) \
        V(WASM_EXCEPTION_OBJECT_TYPE, 1111) \
        V(WASM_GLOBAL_OBJECT_TYPE, 1112) \
        V(WASM_INSTANCE_OBJECT_TYPE, 1113) \
        V(WASM_MEMORY_OBJECT_TYPE, 1114) \
        V(WASM_MODULE_OBJECT_TYPE, 1115) \
        V(WASM_TABLE_OBJECT_TYPE, 1116) \
        V(WASM_VALUE_OBJECT_TYPE, 1117) \
      V(LAST_JS_OBJECT_TYPE, 1117) \
    V(LAST_JS_RECEIVER_TYPE, 1117) \
  V(LAST_HEAP_OBJECT_TYPE, 1117) \
