...
void TestBuiltinSpecialization_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kGenericBuiltinTest_Smi_0), TNode<Object>(), tmp0);
    tmp2 = Null_0(state_);
  ...
  if (block2.is_used()) {
    ...
    tmp5 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kGenericBuiltinTest_Smi_0), TNode<Object>(), tmp4);
    tmp6 = Null_0(state_);
  ...
  if (block4.is_used()) {
    ...
    tmp9 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kGenericBuiltinTest_JSAny_0), TNode<Object>(), tmp8);
  ...
  if (block6.is_used()) {
    ...
    tmp13 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kGenericBuiltinTest_JSAny_0), TNode<Object>(), tmp12);
...
TNode<Oddball> TestUnsafeCast_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Number> p_n) {
  ...
  if (block2.is_used()) {
    ...
    tmp2 = ca_.CallStub<Smi>(Builtins::CallableFor(ca_.isolate(), Builtins::kTestHelperPlus1), TNode<Object>(), tmp1);
...
void TestLoadEliminationFixed_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = ca_.CallStub<SmiBox>(Builtins::CallableFor(ca_.isolate(), Builtins::kNewSmiBox), p_context, tmp0);
...
void TestLoadEliminationVariable_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = ca_.CallStub<SmiBox>(Builtins::CallableFor(ca_.isolate(), Builtins::kNewSmiBox), p_context, tmp2);
...
void TestCallMultiReturnBuiltin_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ...
    tmp2_and_tmp3 = ca_.CallStub<PairT<Smi, Map>>(Builtins::CallableFor(ca_.isolate(), Builtins::kReturnTwoValues), p_context, tmp1, tmp0);
