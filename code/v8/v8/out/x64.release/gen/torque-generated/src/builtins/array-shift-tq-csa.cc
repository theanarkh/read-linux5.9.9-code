...
TNode<Object> GenericArrayShift_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver) {
  ...
  if (block2.is_used()) {
    ...
    tmp6 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, tmp4, tmp5);
  ...
  if (block4.is_used()) {
    ...
    tmp14 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), p_context, tmp0, phi_bb4_5);
    tmp15 = True_0(state_);
  ...
  if (block7.is_used()) {
    ...
    tmp18 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, tmp13, tmp17);
  ...
  if (block8.is_used()) {
    ...
    tmp20 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), p_context, tmp0, tmp13, tmp19);
  ...
  if (block5.is_used()) {
    ...
    tmp26 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), p_context, tmp0, tmp24, tmp25);
    ...
    tmp30 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, tmp27, tmp29);
