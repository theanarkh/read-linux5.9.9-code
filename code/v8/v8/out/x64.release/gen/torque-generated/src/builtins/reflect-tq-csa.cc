...
TF_BUILTIN(ReflectGet, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    tmp6 = ca_.CallStub<Name>(Builtins::CallableFor(ca_.isolate(), Builtins::kToName), parameter0, tmp5);
  ...
  if (block7.is_used()) {
    ...
    tmp12 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kGetPropertyWithReceiver), parameter0, tmp2, tmp6, phi_bb7_8, tmp11);
...
TF_BUILTIN(ReflectDeleteProperty, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    tmp3 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), parameter0, tmp0, parameter2, tmp2);
...
TF_BUILTIN(ReflectHas, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp2 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), parameter0, tmp0, parameter2);
    CodeStubAssembler(state_).Return(tmp2);
  }
}
