...
void CollectCallFeedback_0(compiler::CodeAssemblerState* state_, TNode<Object> p_maybeTarget, std::function<TNode<Object>()> p_maybeReceiver, TNode<Context> p_context, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId) {
  ...
  if (block22.is_used()) {
    ca_.Bind(&block22);
    tmp6 = FeedbackValueIsReceiver_0(state_, TNode<Context>{p_context}, TNode<FeedbackVector>{tmp0}, TNode<UintPtrT>{p_slotId});
    ca_.Branch(tmp6, &block25, std::vector<compiler::Node*>{}, &block26, std::vector<compiler::Node*>{});
  }

  TNode<BoolT> tmp7;
  if (block25.is_used()) {
    ca_.Bind(&block25);
    tmp7 = TaggedEqualPrototypeApplyFunction_0(state_, TNode<Context>{p_context}, TNode<Object>{p_maybeTarget});
    ca_.Goto(&block27, tmp7);
  }
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23);
    tmp9 = CodeStubAssembler(state_).RunLazy(std::function<TNode<Object>()>{p_maybeReceiver});
    tmp10 = IsMonomorphic_0(state_, TNode<MaybeObject>{tmp2}, TNode<Object>{tmp9});
  ...
  if (block29.is_used()) {
    ...
    TryInitializeAsMonomorphic_0(state_, TNode<Context>{p_context}, TNode<Object>{p_maybeTarget}, TNode<FeedbackVector>{tmp0}, TNode<UintPtrT>{p_slotId}, &label11);
    ca_.Goto(&block31);
    if (label11.is_used()) {
      ca_.Bind(&label11);
      ca_.Goto(&block32);
  ...
  if (block35.is_used()) {
    ...
    tmp18 = CodeStubAssembler(state_).TaggedEqual(TNode<MaybeObject>{tmp12}, TNode<MaybeObject>{tmp17});
    ca_.Branch(tmp18, &block37, std::vector<compiler::Node*>{}, &block38, std::vector<compiler::Node*>{});
  }
  ...
  if (block38.is_used()) {
    ...
    tmp19 = Cast_JSFunction_0(state_, TNode<HeapObject>{tmp12}, &label20);
    ca_.Goto(&block39);
    if (label20.is_used()) {
      ca_.Bind(&label20);
      ca_.Goto(&block40);
  ...
  if (block39.is_used()) {
    ...
    ca_.Branch(tmp24, &block41, std::vector<compiler::Node*>{}, &block42, std::vector<compiler::Node*>{});
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Branch(tmp26, &block43, std::vector<compiler::Node*>{}, &block44, std::vector<compiler::Node*>{});
  }
  ...
  if (block45.is_used()) {
    ...
    TryInitializeAsMonomorphic_0(state_, TNode<Context>{p_context}, TNode<Object>{phi_bb45_6}, TNode<FeedbackVector>{tmp0}, TNode<UintPtrT>{p_slotId}, &label28);
    ca_.Goto(&block50);
    if (label28.is_used()) {
      ca_.Bind(&label28);
      ca_.Goto(&block51);
