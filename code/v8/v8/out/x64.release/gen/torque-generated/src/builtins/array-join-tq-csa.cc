...
TNode<String> BufferJoin_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructBuffer_0 p_buffer, TNode<String> p_sep) {
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23);
    tmp21 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kStringRepeat), p_context, p_sep, tmp19);
...
TNode<Object> ArrayJoin_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_receiver, TNode<String> p_sep, TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options) {
  ...
  if (block28.is_used()) {
    ca_.Bind(&block28);
    tmp28 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kStringRepeat), p_context, p_sep, tmp26);
...
TNode<BoolT> JoinStackPushInline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver) {
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp36 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kJoinStackPush), p_context, tmp0, p_receiver);
...
void JoinStackPopInline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver) {
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp20 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kJoinStackPop), p_context, tmp0, p_receiver);
    ca_.Goto(&block18);
  }
...
USE(parameter1);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp5 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kObjectToString), parameter0, tmp0);
...
tmp18 = CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(0)).descriptor(), phi_bb6_11, p_context, p_receiver, phi_bb8_16);
  ...
  if (block9.is_used()) {
    ...
    tmp19 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kConvertToLocaleString), p_context, tmp18, p_locales, p_options);
  ...
  if (block25.is_used()) {
    ...
    tmp30 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kToString), p_context, ca_.UncheckedCast<HeapObject>(tmp18));
