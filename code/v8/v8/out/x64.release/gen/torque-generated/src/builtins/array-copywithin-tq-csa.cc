...
USE(parameter1);
  ...
  if (block8.is_used()) {
    ...
    tmp35 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), parameter0, tmp0, phi_bb8_10);
    tmp36 = True_0(state_);
  ...
  if (block11.is_used()) {
    ...
    tmp39 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), parameter0, tmp0, phi_bb11_8, tmp38);
  ...
  if (block12.is_used()) {
    ...
    tmp41 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), parameter0, tmp0, phi_bb12_8, tmp40);
