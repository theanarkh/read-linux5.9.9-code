...
TF_BUILTIN(TypedArrayMergeSort, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp7 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kTypedArrayMergeSort), parameter0, parameter4, parameter2, tmp3, parameter1, parameter5, parameter6);
    ca_.Goto(&block6);
  }
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp11 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kTypedArrayMergeSort), parameter0, parameter4, tmp3, parameter3, parameter1, parameter5, parameter6);
    ca_.Goto(&block8);
  }
...
tmp29 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp20, TNode<Object>(), tmp7, phi_bb16_15));
  ...
  if (block17.is_used()) {
    ...
    tmp55 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kTypedArrayMergeSort), parameter0, tmp26, tmp54, tmp9, tmp24, tmp7, tmp17);
