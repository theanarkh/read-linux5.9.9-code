...
TNode<String> StringPad_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TorqueStructArguments p_arguments, const char* p_methodName, int31_t p_variant) {
  ...
  if (block32.is_used()) {
    ...
    tmp31 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kStringRepeat), p_context, phi_bb32_8, tmp28);
  ...
  if (block33.is_used()) {
    ...
    tmp37 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kStringRepeat), p_context, phi_bb33_8, tmp36);
  ...
  if (block35.is_used()) {
    ...
    tmp42 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kStringSubstring), p_context, phi_bb35_8, tmp41, tmp40);
