...
TF_BUILTIN(GetIteratorWithFeedback, CodeStubAssembler) {
  ...
  if (block11.is_used()) {
    ...
    tmp3 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kLoadIC), parameter0, parameter1, tmp2, parameter2, ca_.UncheckedCast<FeedbackVector>(parameter4));
  ...
  if (block8.is_used()) {
    ...
    tmp7 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kCallIteratorWithFeedback), parameter0, parameter1, phi_bb8_5, tmp6, parameter4);
...
TF_BUILTIN(GetIteratorBaseline, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = CodeStubAssembler(state_).IteratorSymbolConstant();
    tmp3 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kLoadIC), tmp0, parameter0, tmp2, parameter1, tmp1);
    tmp4 = CodeStubAssembler(state_).TaggedIndexToSmi(TNode<TaggedIndex>{parameter2});
    tmp5 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kCallIteratorWithFeedback), tmp0, parameter0, tmp3, tmp4, tmp1);
