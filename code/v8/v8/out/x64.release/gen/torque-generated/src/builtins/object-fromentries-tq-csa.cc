...
TNode<JSObject> ObjectFromEntriesFastCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_iterable, compiler::CodeAssemblerLabel* label_IfSlow) {
  ...
  if (block17.is_used()) {
    ...
    tmp18 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetPropertyInLiteral), p_context, tmp7, tmp11, tmp12);
  ...
  if (block21.is_used()) {
    ...
    tmp21 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetPropertyInLiteral), p_context, tmp7, tmp11, tmp12);
  ...
  if (block25.is_used()) {
    ...
    tmp24 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetPropertyInLiteral), p_context, tmp7, tmp23, tmp12);
