...
TNode<Object> FastArraySplice_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o, TNode<Number> p_originalLengthNumber, TNode<Number> p_actualStartNumber, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCountNumber, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block43.is_used()) {
    ...
    tmp43 = ca_.CallStub<JSArray>(Builtins::CallableFor(ca_.isolate(), Builtins::kExtractFastJSArray), p_context, tmp8, tmp2, tmp4);
...
TNode<Object> FillDeletedElementsArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount, TNode<JSReceiver> p_a) {
  ...
  if (block2.is_used()) {
    ...
    tmp3 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), p_context, p_o, tmp2);
    tmp4 = True_0(state_);
  ...
  if (block5.is_used()) {
    ...
    tmp7 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastCreateDataProperty), p_context, p_a, phi_bb5_5, tmp6);
  ...
  if (block3.is_used()) {
    ...
    tmp11 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, p_a, tmp10, p_actualDeleteCount);
    ca_.Goto(&block7);
  }
...
void HandleForwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount) {
  ...
  if (block2.is_used()) {
    ...
    tmp4 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), p_context, p_o, tmp2);
    tmp5 = True_0(state_);
  ...
  if (block5.is_used()) {
    ...
    tmp8 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, p_o, tmp3, tmp7);
  ...
  if (block6.is_used()) {
    ...
    tmp10 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), p_context, p_o, tmp3, tmp9);
  ...
  if (block8.is_used()) {
    ...
    tmp19 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), p_context, p_o, tmp17, tmp18);
...
void HandleBackwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount) {
  ...
  if (block2.is_used()) {
    ...
    tmp8 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), p_context, p_o, tmp4);
    tmp9 = True_0(state_);
  ...
  if (block5.is_used()) {
    ...
    tmp12 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, p_o, tmp7, tmp11);
    ca_.Goto(&block7, phi_bb5_6);
  }
  ...
  if (block6.is_used()) {
    ...
    tmp14 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), p_context, p_o, tmp7, tmp13);
    ca_.Goto(&block7, phi_bb6_6);
  }
...
TNode<Object> SlowSplice_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_arguments, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_actualStart, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCount) {
  ...
  if (block9.is_used()) {
    ...
    tmp9 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, p_o, phi_bb9_11, tmp8);
  ...
  if (block8.is_used()) {
    ...
    tmp17 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, p_o, tmp14, tmp16);
    ca_.Goto(&block13);
  }
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = ca_.CallStub<JSReceiver>(Builtins::CallableFor(ca_.isolate(), Builtins::kToObject), parameter0, parameter1);
