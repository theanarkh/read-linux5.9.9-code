...
TNode<String> RegExpReplaceFastString_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<String> p_replaceString) {
  ...
  if (block9.is_used()) {
    ...
    tmp13 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kSubString), p_context, p_string, phi_bb9_5, tmp11);
  ...
  if (block5.is_used()) {
    ...
    tmp28 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kSubString), p_context, p_string, phi_bb5_5, tmp27);
...
TF_BUILTIN(RegExpReplace, CodeStubAssembler) {
  ...
  if (block15.is_used()) {
    ...
    tmp10 = ca_.CallStub<Smi>(Builtins::CallableFor(ca_.isolate(), Builtins::kStringIndexOf), parameter0, tmp2, tmp8, tmp9);
...
USE(parameter1);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp11 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kRegExpReplace), parameter0, tmp7, tmp6, tmp3);
