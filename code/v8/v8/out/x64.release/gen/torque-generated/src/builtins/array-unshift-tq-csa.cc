...
TNode<Number> GenericArrayUnshift_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TorqueStructArguments p_arguments) {
  ...
  if (block6.is_used()) {
    ...
    tmp15 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kHasProperty), p_context, tmp0, tmp11);
    tmp16 = True_0(state_);
  ...
  if (block9.is_used()) {
    ...
    tmp19 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, tmp14, tmp18);
  ...
  if (block10.is_used()) {
    ...
    tmp21 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kDeleteProperty), p_context, tmp0, tmp14, tmp20);
  ...
  if (block12.is_used()) {
    ...
    tmp28 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, phi_bb12_9, tmp27);
  ...
  if (block3.is_used()) {
    ...
    tmp33 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kSetProperty), p_context, tmp0, tmp32, tmp31);
    ca_.Goto(&block15);
  }
