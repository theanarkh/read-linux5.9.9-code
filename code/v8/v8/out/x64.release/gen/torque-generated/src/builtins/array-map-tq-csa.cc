...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp8 = kZero_0(state_);
    tmp9 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayMapLoopContinuation), parameter0, tmp0, tmp6, parameter3, tmp2, tmp0, tmp8, tmp4);
...
USE(parameter1);
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp10 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayMapLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp4, tmp0, tmp6, tmp8);
...
USE(parameter1);
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp10 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastCreateDataProperty), parameter0, tmp4, tmp6, parameter7);
    ...
    tmp13 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayMapLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp4, tmp0, tmp12, tmp8);
...
TF_BUILTIN(ArrayMapLoopContinuation, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    tmp6 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastCreateDataProperty), parameter0, parameter4, phi_bb5_8, tmp5);
...
USE(parameter1);
  ...
  if (block7.is_used()) {
    ...
    tmp22 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kArrayMapLoopContinuation), parameter0, tmp1, tmp7, tmp10, phi_bb7_9, tmp1, phi_bb7_10, tmp2);
