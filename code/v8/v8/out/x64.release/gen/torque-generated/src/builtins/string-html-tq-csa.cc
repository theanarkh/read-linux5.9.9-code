...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    tmp5 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kCreateHTML), parameter0, parameter1, tmp2, tmp3, tmp4, tmp1);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    tmp4 = ca_.CallStub<String>(Builtins::CallableFor(ca_.isolate(), Builtins::kCreateHTML), parameter0, parameter1, tmp2, tmp3, tmp0, tmp1);
