...
USE(parameter1);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp2 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kPromiseResolve), parameter0, tmp0, parameter2);
...
TF_BUILTIN(PromiseResolve, CodeStubAssembler) {
  ...
  if (block15.is_used()) {
    ...
    tmp25 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kResolvePromise), parameter0, tmp24, parameter2);
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    tmp26 = True_0(state_);
    tmp27 = ca_.CallStub<PromiseCapability>(Builtins::CallableFor(ca_.isolate(), Builtins::kNewPromiseCapability), parameter0, parameter1, tmp26);
...
TF_BUILTIN(ResolvePromise, CodeStubAssembler) {
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    tmp6 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kFulfillPromise), parameter0, parameter1, parameter2);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    tmp12 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kFulfillPromise), parameter0, parameter1, parameter2);
  ...
  if (block28.is_used()) {
    ca_.Bind(&block28);
    tmp23 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kFulfillPromise), parameter0, parameter1, parameter2);
  ...
  if (block35.is_used()) {
    ...
    tmp44 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kRejectPromise), parameter0, parameter1, tmp40, tmp43);
  ...
  if (block36.is_used()) {
    ca_.Bind(&block36);
    tmp45 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kFulfillPromise), parameter0, parameter1, parameter2);
  ...
  if (block7.is_used()) {
    ...
    tmp51 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtins::kEnqueueMicrotask), tmp50, tmp48);
