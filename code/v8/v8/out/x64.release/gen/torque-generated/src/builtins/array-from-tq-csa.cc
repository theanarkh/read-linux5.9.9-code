...
USE(parameter1);
  ...
  if (block43.is_used()) {
    ...
    tmp51 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastCreateDataProperty), parameter0, phi_bb26_11, phi_bb43_15, phi_bb43_18);
    }
  ...
  if (block60.is_used()) {
    ...
    tmp63 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastCreateDataProperty), parameter0, phi_bb51_12, phi_bb60_13, phi_bb60_15);
